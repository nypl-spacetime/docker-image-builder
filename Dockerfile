...
run git clone https://github.com/nypl-spacetime/etl-fast.git
run git clone https://github.com/nypl-spacetime/etl-registry.git
run git clone https://github.com/nypl-spacetime/etl-building-inspector-nyc-streets.git
run git clone https://github.com/nypl-spacetime/etl-geonames.git
run git clone https://github.com/nypl-spacetime/etl-whosonfirst.git
run git clone https://github.com/nypl-spacetime/etl-tgn.git
run git clone https://github.com/nypl-spacetime/etl-nyc-wards.git
run git clone https://github.com/nypl-spacetime/etl-1854-directory.git
run git clone https://github.com/nypl-spacetime/etl-tgn-geonames.git
run git clone https://github.com/nypl-spacetime/etl-cemeteries.git
run git clone https://github.com/nypl-spacetime/etl-wikidata.git
run git clone https://github.com/nypl-spacetime/etl-liesin-per-dataset.git
run git clone https://github.com/nypl-spacetime/etl-building-inspector-1854-directory.git
...
run git clone https://github.com/nypl-spacetime/etl-menus.git
